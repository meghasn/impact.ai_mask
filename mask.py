...
def create_mask(image_path,file_name,path):
    pic_path = image_path
    mask_path = "C:/Users/pnc/Documents/impact.ai/mask-feature-exp/images/blue-mask.png"
    show = False
    model = "hog"
    FaceMasker(pic_path, mask_path,file_name,path, show, model).mask()
...
class FaceMasker:
    ...
    def __init__(self, face_path, mask_path,file_name,path, show=False, model='hog'):
    ...
    def _save(self):
        ...
        # print(path_splits[1])
        # new_face_path = self.file_name + '-with-mask' + path_splits[1]
        
        # print(new_face_path)
        # print(self.fold_name)
        print(self.file_name)
        self._face_img.save(self.path+"/"+self.file_name)
